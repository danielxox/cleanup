...
EXT_AUDIO = ['mp3', 'wav', 'ogg', 'wma', 'mid', 'midi', 'flac', 'raw']
EXT_VIDEO = ['mp4', 'mkv', 'webm', 'mpeg', 'avi', 'mov', 'flv', 'wmv', 'm4v', 'h264']
EXT_IMGS  = ['png', 'jpg', 'jpeg', 'gif', 'webp', 'svg', 'bmp', 'psd', 'svg', 'tiff', 'tif']
EXT_DOCS  = ['txt', 'pdf', 'csv', 'xls', 'xlsx', 'ods', 'doc', 'docx', 'html', 'odt', 'tex', 'ppt', 'pptx', 'log']
EXT_COMPR = ['zip', 'z', '7z', 'rar', 'tar', 'gz', 'rpm', 'pkg', 'deb']
EXT_INSTL = ['exe', 'iso', 'py']
